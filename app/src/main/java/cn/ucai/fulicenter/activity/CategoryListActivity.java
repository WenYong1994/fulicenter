...
public class CategoryListActivity extends AppCompatActivity {
    ...
    @Bind(R.id.category_list_title_back)
    ImageView categoryListTitleBack;
    @Bind(R.id.category_list_title_text)
    TextView categoryListTitleText;
    @Bind(R.id.category_list_title_arrow_up)
    ImageView categoryListTitleArrowUp;
    @Bind(R.id.category_list_title_center)
    LinearLayout categoryListTitleCenter;
    @Bind(R.id.category_list_priace)
    ImageView categoryListPriace;
    @Bind(R.id.category_list_time)
    ImageView categoryListTime;
    @Bind(R.id.category_list_hint)
    TextView tvHint;
    @Bind(R.id.category_list_recycler)
    ...
    private void setBoutiqueSencondBack() {
        categoryListTitleBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MFGT.finish(CategoryListActivity.this);
            }
    ...
    private void setRecycler() {
        categoryListRecycler.setOnScrollListener(new RecyclerView.OnScrollListener() {
    ...
    private void initView() {
        ...
        categoryListRecycler.setLayoutManager(mGridaLayoutManager);
        categoryListRecycler.setAdapter(mGoodsAdapter);
